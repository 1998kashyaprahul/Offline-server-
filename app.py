...
text= "💙💚❤️THIS WEB PAGE IS MADE BY Mr Shaitan Rulex 💫💯🟥🟨🟧OWNER :- Mr.YK TRICKS INDIA ✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 Shaitan Rulex✨</h1>
            <h3>OWNER BY MR. Shaitan Rulex ❤️</h3>
          </header>
          ...
          <footer class="footer">
            <p>&copy; Developed by Shaitan Rulex 2025. All Rights Reserved.</p>
